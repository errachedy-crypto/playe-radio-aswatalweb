...
# Example content for version.json: {"latest_version": "1.4", "download_url": "https://github.com/user/repo/releases/latest"}
...
class RadioWindow(QMainWindow):
    ...
    def show_update_dialog(self, new_version, download_url):
        ...
        reply = QMessageBox.information(self, title, message, QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
